 ...
 */
const myNewBlogNote = defineNoteConfig({
  dir: 'my-new-blog',
  link: '/my-new-blog/',
  sidebar: 'auto',
})

const zhFrontendTechNote = defineNoteConfig({
  dir: 'frontend-tech',
  link: '/frontend-tech/',
  sidebar: 'auto',
})

const zhPreviewNote = defineNoteConfig({
  dir: 'preview',
  link: '/preview/',
  sidebar: 'auto',
})
 ...
 */
const enMyNewBlogNote = defineNoteConfig({
  dir: 'en/my-new-blog',
  link: '/en/my-new-blog/',
  sidebar: 'auto',
})
...
export const enNotes = defineNotesConfig({
  dir: 'en/notes',
  link: '/en/',
  notes: [enDemoNote, enMyNewBlogNote],
})
